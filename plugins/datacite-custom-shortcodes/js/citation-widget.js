(function() {
	...
	function init(){
		jQuery(document).ready(function($) {
			...
			if (generateSchema === true){
				$.ajax({
					url: SCHEMA_URL + encodeURIComponent(doi.replace("https://doi.org/", "")),
	...
	function showSuccess($, res){
		$('<p>' + res + '</p><p><small>Powered by the <a href="https://citation.doi.org/">DOI Citation Formatter</a></small></p>').appendTo(ELEMENT_ID);
	}
	function showError($){
